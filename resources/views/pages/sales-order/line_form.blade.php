...
@section('content')
    <div class="main-content group-data-[sidebar-size=lg]:xl:ml-[322px]">
        @php
            $salesOrderIdEncrypted = request()->query('document_id');
            // Assuming document_id is passed to view via Controller
        @endphp

        <!-- Header / Breadcrumb -->
        <div class="flex items-center justify-between mb-6">
            <a href="{{ route('sales-order.index', ['document_id' => $document_id, 'tab' => 'lines']) }}"
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm dark:bg-gray-900 dark:border-gray-800">
            ...
            <div class="border-b border-gray-200 dark:border-gray-700">
                <nav class="-mb-px flex space-x-8 px-6" aria-label="Tabs">
                    <a href="{{ route('sales-order.index', ['document_id' => $document_id]) }}"
            ...
            <div class="p-6">
                ...
                <form action="{{ route('sales-order.line.store') }}" method="POST">
                    @csrf
