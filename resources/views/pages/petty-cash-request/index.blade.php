                                                    ...
                                                    <tr class="border-t border-gray-200 dark:border-gray-800">
                                                        ...
                                                        <td class="px-4 py-3">
                                                            <div class="flex items-center space-x-2">
                                                                <a href="{{ route('petty-cash-request.index', ['document_id' => \Illuminate\Support\Facades\Crypt::encryptString($request->tcf_pettycash_request_id)]) }}"
                ...
                @if(isset($requests) && $requests->total() > 0)
                    <div
                        ...
                        <div class="text-sm text-gray-500 dark:text-gray-400">
                            Showing <span
                                class="font-medium text-gray-900 dark:text-white">{{ $requests->firstItem() ?? 0 }}</span>
