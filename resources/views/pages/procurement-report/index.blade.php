...
@section('content')
    <div class="space-y-6">
        ...
        <div class="rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
            ...
            <div class="p-6">
                <!-- Filter Form -->
                <form id="filterForm" class="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
                    ...
                    <div class="md:col-span-3">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="search_query" name="search_query"
                                placeholder="Search Document No or Product..."
    ...
    @push('scripts')
        <script>
            ...
            function fetchData(page = 1) {
                                    ...
                                    <tr>
                                        <td colspan="8" class="py-12  text-center">
                                            <div class="inline-flex items-center gap-2 text-brand-600">
                                                ...
                                                <span class="font-medium animate-pulse">Loading page ${page}...</span>
                                            </div>
                                        </td>
                                    </tr>
                                `;
                ...
                axios.get(`{{ route('procurement-report.data') }}?${params.toString()}`)
                    .then(response => {
                        const res = response.data; // Pagination object (current_page, data, etc.)
            ...
            function renderTable(data, fromIndex) {
                ...
                data.forEach((row, index) => {
                    const reqDate = formatDate(row.req_date);
                                        ...
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex flex-col">
                                                    <span class="text-sm font-medium text-brand-600 dark:text-brand-400">${row.req_num || '-'}</span>
                                                    ${reqDate ? `<span class="text-xs text-gray-400 font-mono mt-0.5">${reqDate}</span>` : ''}
                                                </div>
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-right text-gray-600 dark:text-gray-300 font-mono">
                                                ${formatNumber(row.req_qty)}
                                            </td>

                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">
                                                <div class="flex flex-col">
                                                    ${row.po_num ? `<span class="bg-blue-50 text-blue-700 px-2 py-0.5 rounded text-xs font-medium dark:bg-blue-900/30 dark:text-blue-400 w-fit">${row.po_num}</span>` : '-'}
            ...
            function exportExcel() {
                ...
                window.location.href = `{{ route('procurement-report.export') }}?${params.toString()}`;
            }
            ...
            function formatNumber(value) {
                ...
                // Remove trailing zeros for a slightly cleaner look if desired, or keep fixed
                // return parseFloat(value).toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 4 });

                // If it's pure integer like 4.0000, maybe show 4
