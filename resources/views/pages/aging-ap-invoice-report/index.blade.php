    ...
    <div class="main-content group-data-[sidebar-size=lg]:xl:ml-[322px]">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <nav>
                <ol class="flex items-center gap-2">
                    ...
                    <li class="font-medium text-primary">Aging AP Invoice Report</li>
                </ol>
            </nav>
        </div>
        ...
        <div id="table-container" class="relative min-h-[400px]">
            ...
            <div id="table-content">
                @include('pages.aging-ap-invoice-report.partials.table', ['invoices' => $invoices])
            </div>
        </div>
    </div>
@endsection
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (typeof $ !== 'undefined') {
                ...
                $('#supplierFilter').select2({
                    ajax: {
                        url: '{{ route("aging-ap-invoice.suppliers") }}',
                        dataType: 'json',
                        delay: 250,
                ...
                $('#agingPeriodFilter, #supplierFilter').on('change', function () {
                    fetchData();
                });
            } else {
        ...
        function fetchData(page = 1) {
            ...
            const newUrl = "{{ route('aging-ap-invoice.index') }}?" + params.toString();
