    ...
    @push('scripts')
        ...
        <script>
            ...
            function initScripts() {
                ...
                $('#priority_rule, #org_id, #warehouse_id, #pricelist_id, #tcf_ad_user_checked_id, #tcf_ad_user_approved_id, #cost_center_id').select2({
                    width: '100%',
                    placeholder: '- Select -'
                });
            ...
            function submitHeader() {
                ...
                const data = {
                    ...
                    tcf_ad_user_checked_id: $('#tcf_ad_user_checked_id').val(),
                    tcf_ad_user_approved_id: $('#tcf_ad_user_approved_id').val(),
