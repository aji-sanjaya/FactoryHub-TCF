...
@section('content')
    @php
        ...
        $statusLabel = $statusConfig['labels'][$requisition->docstatus] ?? ($requisition->status_label ?? $requisition->docstatus);
        $statusClass = $statusConfig['badge_classes'][$statusLabel] ?? 'bg-gray-100 text-gray-800';
        $canTakeAction = in_array($requisition->docstatus, $statusConfig['actionable']) && $isMyApproval;
    @endphp
