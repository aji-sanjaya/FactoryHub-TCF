            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'name' => 'Procurement',
                        'subItems' => [
                            ['name' => 'Requisition', 'path' => '/create-pr'],
                            ['name' => 'Purchase Order', 'path' => '/create-po'],
                            ['name' => 'Goods Receipt', 'path' => '/create-gr'],
                            ['name' => 'AP Invoice', 'path' => '/create-ap-invoice'],
                            ['name' => 'AP Payment', 'path' => '/create-ap-payment'],
                        ],
                    ],
                    [
                        'icon' => 'briefcase',
                        'name' => 'Approval',
                        'subItems' => [
                            ['name' => 'Approval PR', 'path' => '/approval-pr'],
                            ['name' => 'Approval PO', 'path' => '/approval-po'],
                        ],
                    ],
                    [
                        'icon' => 'bot-icon',
